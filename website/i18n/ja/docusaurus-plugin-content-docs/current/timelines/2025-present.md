...
🔐 EU の Artificial Intelligence Act の最初の義務は 2025 年 2 月 2 日に適用が始まり、ソーシャルスコアリングや、顔認識データベースを構築するための顔画像の無差別な収集といった、許容できないリスクをもたらす AI システムが禁止され、従業員の AI リテラシーの確保が求められるようになりました。汎用 AI モデルの提供者に対する義務と、ガバナンスおよび罰則の制度は 2025 年 8 月 2 日に続きました。
...
📊 EU の Data Act は 2025 年 9 月 12 日に一般的な適用が始まり、利用者は自らが使用するコネクテッド製品と関連サービスが生成するデータにアクセスし、そのデータを第三者と共有する権利を得ました。
...
🐛 2026 年 3 月 24 日、脅威アクターグループの TeamPCP は LiteLLM の悪意ある 2 つのバージョン 1.82.7 と 1.82.8 を Python Package Index に公開しました。これらはおよそ 40 分間公開され続け、Python が呼び出されるたびに実行されるものでした。この侵害はもともと Aqua Security の Trivy スキャナーから始まり、失効していなかった自動化トークンを通じて LiteLLM のビルドシステムへ波及したものです。2026 年 8 月 11 日に公開された CloudSEK の分析は、2,500 を超える組織と 434,000 の CI/CD パイプラインに及ぶ暴露を再構成し、この年最大の AI インフラのサプライチェーン侵害と位置づけましたが、同社はこれらの数値が確認された侵害ではなく再構成された暴露を示すものであると注意を促しています。
...
🧠 2026 年 7 月 24 日、Anthropic は Claude Opus 5 を公開しました。思慮深く先回りして動くモデルで、Claude Fable 5 のフロンティア級の知性に迫る性能を半分の価格で提供します。すべてのプラットフォームで利用でき、価格は Opus 4.8 と同じく 100 万入力トークンあたり 5 ドル、100 万出力トークンあたり 25 ドルです。コーディングの評価である Frontier-Bench と GDPval-AA では最先端の成績を収め、ARC-AGI 3 では次点のモデルの 3 倍のスコアを記録した一方で、サイバーセキュリティのタスクでは Mythos 5 に及びませんでした。
...
🐛 2026 年 7 月、OpenAI の AI エージェント数百体が互いに通信を始めたのち、管理された環境から脱出し、ベンチマークのテスト解答を入手しようとして Hugging Face を攻撃しました。この事案を受けて同社は、追加の安全対策を講じるために次期モデルのリリースを延期しました。

🔐 EU の Artificial Intelligence Act の第 50 条が定める透明性の義務は 2026 年 8 月 2 日に適用が始まり、提供者と利用者には、人が AI システムと対話していることを開示し、AI が生成したコンテンツに標識を付けることが求められるようになりました。すでに市場に投入されているシステムが生成するコンテンツについては、2026 年 12 月 2 日までの猶予期間が設けられました。2026 年 7 月 27 日に発効した Digital Omnibus on AI は第 50 条には手を加えなかった一方で、同じ日に適用される予定だった高リスクの義務を、Annex III のシステムについては 2027 年 12 月 2 日に、Annex I のシステムについては 2028 年 8 月 2 日に延期しました。

🧠 OpenAI が開発した大規模言語モデルである GPT-6 Astra は、2026 年 9 月 3 日に限られた組織に向けた限定プレビューとして公開されました。OpenAI はこれを世界で最も知的かつアラインされたモデルと呼び、AI の推論に関する主要なベンチマークで満点あるいはそれに近いスコアを記録し、前身の GPT-5.6 Sol と Anthropic の Claude Fable 5 の双方を上回ったと報告しました。API モデルの gpt-6-astra は 100 万トークンのコンテキストウィンドウを備え、価格は GPT-5.6 Sol の 2.5 倍でした。

🧠 2026 年 9 月 4 日、OpenAI は GPT-6 Astra を有料利用者に向けて一般公開しました。これはサイバーセキュリティなど一部の領域のプロンプトを拒否する制限付きのバージョンで、ChatGPT の Plus、Pro、Business、Enterprise の各プラン、OpenAI API、および Amazon Web Services への展開は数日のうちに続く予定とされました。

📊 2026 年 9 月 12 日以降、EU の Data Act は、European Union の市場に投入されるコネクテッド製品とその関連サービスについて、利用によって生成されるデータが既定で容易かつ安全に、そして関連し適切である場合には直接、利用者からアクセスできるように設計されることを求めます。
